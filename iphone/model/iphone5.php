...
$sql = $mysqli->query("SELECT id,product_name,product_img_name, product_desc, price, qty
                            FROM products, categories WHERE categories.cat_name='iphone' AND products.cat_id = categories.cat_id");

if ($sql) {

	while ($obj = $sql->fetch_object()) {

		echo '<div class="g-pad grid-item">';
		echo '<div class="product-card" style="box-shadow: 5px 5px 2px 1px rgba(192, 192, 192, 0.68);">';
		echo '<a class="product-thumb"><img src="iphone-5/'.$obj->product_img_name.'"></a>';
