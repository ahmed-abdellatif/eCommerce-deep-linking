          ...
          <li><a href="#"><span>Phone Cases</span></a>
            <ul class="sub-menu">
              ...
              <li class="has-children"><a href="../lg.php">LG</a>
                <ul class="sub-menu">
                  <li><a href="aristo.php" name="">Aristo</a></li>
                  <li><a href="stylo.php" name="">Stylo</a></li>
                </ul>
              </li>
          ...
          <div class="offcanvas-wrapper">
            <div class="container padding-bottom-3x mb-1">
                ...
                <h6 class="text-muted text-normal text-uppercase padding-top-5x mt-2" style="text-align:center;">LG Models</h6>
                  ...
                  <li class="nav-item"><a class="nav-link" href="../iphone.php">iPhone Home</a></li>
                 <li class="nav-item"><a class="nav-link" href="iphone5.php" name="iphone5">iPhone 5</a></li>
                  <li class="nav-item"><a class="nav-link" href="iphone6.php" name="">iPhone 6</a>
                  </li>
                  <li class="nav-item"><a class="nav-link" href="iphone7.php" name="">iPhone 7</a>
                  </li>
                  <li class="nav-item"><a class="nav-link" href="iphone7-plus.php" name="">iPhone 7 Plus</a>
                  </li>
                  <li class="nav-item"><a class="nav-link" href="iphone8.php" name="">iPhone 8</a>
                  </li>
                  <li class="nav-item"><a class="nav-link" href="iphone8-plus.php" name="">iPhone 8 Plus</a>
                  </li>
                  <li class="nav-item"><a class="nav-link" href="iphone-x.php" name="">iPhone X</a>
                  </li>
