    ...
    <!-- Off-Canvas Wrapper-->
          ...
          <div class="offcanvas-wrapper">
            <div class="container padding-bottom-3x mb-1">
                ...
                <h6 class="text-muted text-normal text-uppercase padding-top-5x mt-2" style="text-align:center;">iPhone</h6>
                   <hr class="margin-bottom-1x">
                   <ul class="nav nav-pills nav-justified">
                     <li class="nav-item"><a class="nav-link" href="../index.php">Homepage</a></li>
                     <li class="nav-item"><a class="nav-link" href="../iphone.php">iPhone Home</a></li>
                     <li class="nav-item"><a class="nav-link" href="model/iphone5.php">iPhone 5</a></li>
                     <li class="nav-item"><a class="nav-link"  href="model/iphone78.php">iPhone 7/8</a></li>
