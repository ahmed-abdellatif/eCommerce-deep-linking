...
header.php or footer.php work by telling the file (which is referencing it), what to output & Where to go
(by giving directions to be followed from inside the file that is referencing it. In other words, header.php
and footer.php are not calling assets for their own pleasure. rather they are directing you )

require statements are 'paths' NOT functions
          ...
          <li><a href="#"><span>Phone Cases</span></a>
            <ul class="sub-menu">
              <li class="has-children"><a href="../../iphone/iphone.php">iPhones</a>
                <ul class="sub-menu">
                 <li><a href="../../iphone/model/iphone5.php" name="iphone5">iPhone 5</a></li>
                  ...
                  <li><a href="../../iphone/model/iphone7-plus.php" name="">iPhone 7 Plus</a>
                  </li>
              ...
              <li class="has-children"><a href="../samsung.php">Samsung</a>
                <ul class="sub-menu">
                  <li>
                    <a href="galaxy-8.php" name="">Galaxy S8</a>
                  </li>
                  <li>
                    <a href="galaxy-8-plus.php" name="i5s" />Galaxy S8 Plus</a>
                  </li>
                <li>
                    <a href="galaxy-j3-emerge.php" name="i5s" />Galaxy J3 Emerge</a>
                  </li>
                  <li>
                    <a href="galaxy-s7-edge.php" name="">Galaxy S7 Edge</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="has-children"><a href="../../motorola/motorola.php">Motorola</a>
                <ul class="sub-menu">
                  <li><a href="../../motorola/motorola/motorola-brand.php" name="i5">Moto G55 Play</a></li>
                </ul>
              </li>

              <!--LG -->
              <li class="has-children"><a href="../../lg/lg.php">LG</a>
                <ul class="sub-menu">
                  <li><a href="../../lg/model/aristo.php" name="">LG</a></li>
                </ul>
              </li>
              ...
              <li class="has-children"><a href="../../zte/zte.php">ZTE</a>
                <ul class="sub-menu">
                  <li><a href="../../zte/model/zte-brand.php" name="">ZTE</a></li>
                </ul>
              </li>
              ...
              <li class="has-children"><a href="../../alcatel/alcatel.php">Alcatel</a>
                <ul class="sub-menu">
                  <li><a href="../../alcatel/model/alcatel-brand.php" name="">Alcatel</a></li>
                </ul>
              </li>
             ...
             <!--Coolpad -->
              <li class="has-children"><a href="../../coolpad/coolpad.php">Coolpad</a>
                <ul class="sub-menu">
                  <li><a href="../../coolpad/model/model-1.php" name="">Coolpad</a></li>
                </ul>
              </li>
              ...
              <li class="has-children"><a href="../../google/google.php">Google</a>
                <ul class="sub-menu">
                  <li><a href="../../google/model/googleModel1.php" name="">google</a></li>
                </ul>
              </li>
        ...
        <div class="container padding-bottom-3x mb-1">
            ...
            <h6 class="text-muted text-normal text-uppercase padding-top-5x mt-2" style="text-align:center;">Samsung</h6>
               ...
               <ul class="nav nav-pills nav-justified">
                 <li class="nav-item"><a class="nav-link" href="../../index.php">Main Home</a></li>
                 <li class="nav-item"><a class="nav-link" href="../samsung.php">Samsung Home</a></li>
                 <li class="nav-item"><a class="nav-link" href="galaxy-8.php">Galaxy S8</a></li>
                 <li class="nav-item"><a class="nav-link" href="galaxy-8-plus.php">Galaxy S8 Plus</a></li>
                 <li class="nav-item"><a class="nav-link" href="galaxy-s7-edge.php">Galaxy S7 Edge</a></li>
                 <li class="nav-item"><a class="nav-link" href="galaxy-j3-emerge.php">Galaxy J3 Emerge</a></li>
