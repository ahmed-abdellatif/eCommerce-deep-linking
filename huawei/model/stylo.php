...
$sql = $mysqli->query("SELECT id,product_name,product_img_name, product_desc, price, qty
                            FROM products, categories WHERE categories.cat_name='stylo' AND products.cat_id = categories.cat_id");
...
if ($sql) {
	...
	while ($obj = $sql->fetch_object()) {
		...
		echo '<a class="product-thumb"><img src="stylo-photos/'.$obj->product_img_name.'"></a>';
