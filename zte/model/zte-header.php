          ...
          <li><a href="#"><span>Phone Cases</span></a>
            <ul class="sub-menu">
              ...
              <li class="has-children"><a href="../../lg/lg.php">LG</a>
                <ul class="sub-menu">
                  <li><a href="../../lg/model/aristo.php" name="">Aristo</a></li>
                </ul>
              </li>

              <!--ZTE -->
              <li class="has-children"><a href="../zte.php">ZTE</a>
                <ul class="sub-menu">
                  <li><a href="zte-brand.php" name="">ZTE</a></li>
                </ul>
              </li>
