    ...
    <!-- Off-Canvas Wrapper-->
          ...
          <div class="offcanvas-wrapper">
            <div class="container padding-bottom-3x mb-1">
                ...
                <h6 class="text-muted text-normal text-uppercase padding-top-5x mt-2" style="text-align:center;">ZTE</h6>
          ...
          <div class="offcanvas-wrapper">
            <div class="container padding-bottom-3x mb-1">
                ...
                <h6 class="text-muted text-normal text-uppercase padding-top-5x mt-2" style="text-align:center;">ZTE</h6>
                   ...
                   <ul class="nav nav-pills nav-justified">
                     <li class="nav-item"><a class="nav-link" href="../index.php">Homepage</a></li>
                     <li class="nav-item"><a class="nav-link" href="z.php">ZTE Home</a></li>
