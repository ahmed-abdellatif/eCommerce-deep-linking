            ...
            <div class="container padding-bottom-3x mb-1">
                ...
                <h6 class="text-muted text-normal text-uppercase padding-top-5x mt-2" style="text-align:center;">LG Models</h6>
                   ...
                   <ul class="nav nav-pills nav-justified">
                     ...
                     <li class="nav-item"><a class="nav-link" href="aristo.php">Aristo</a></li>
                     <li class="nav-item"><a class="nav-link"  href="stylo.php">Stylo</a></li>
                     <li class="nav-item"><a class="nav-link"  href="tribute.php">Tribute</a></li>
                     <li class="nav-item"><a class="nav-link"  href="xpower.php">X Power</a></li>
