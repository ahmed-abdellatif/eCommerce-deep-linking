        ...
        <ul>
          ...
          <li><a href="#"><span>Phone Cases</span></a>
            <ul class="sub-menu">
              ...
              <!--Motorola -->
              <li class="has-children"><a href="motorola.php">Motorola</a>
                <ul class="sub-menu">
                  <li><a href="model/moto-e4.php">Moto E4</a></li>
                  <li><a href="model/moto-e4-plus.php">Moto E4 Plus</a></li>
                  <li><a href="model/z2-play.php">Moto E4 Plus</a></li>
                </ul>
              </li>
            ...
            <div class="container padding-bottom-3x mb-1">
                ...
                <h6 class="text-muted text-normal text-uppercase padding-top-5x mt-2" style="text-align:center;">LG Models</h6>
                   ...
                   <ul class="nav nav-pills nav-justified">
                     ...
                     <li class="nav-item"><a class="nav-link" href="model/moto-e4.php">Moto E4</a></li>

                     <li class="nav-item"><a class="nav-link"  href="model/moto-e4-plus.php">Moto E4-Plus</a></li>

                    <li class="nav-item"><a class="nav-link" href="model/z2-play.php">Z2 Play</a></li>
