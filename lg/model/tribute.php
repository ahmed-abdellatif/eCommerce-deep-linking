...
$sql = $mysqli->query("SELECT id,product_name,product_img_name, product_desc, price, qty
                            FROM products, categories WHERE categories.cat_name='tribute' AND products.cat_id = categories.cat_id LIMIT 5");
...
if ($sql) {
	...
	while ($obj = $sql->fetch_object()) {
		...
		echo '<a class="product-thumb"><img src="tribute-photos/'.$obj->product_img_name.'"></a>';
